...
def main():
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            best_epoch = epoch
            epochs_no_improve = 0
            torch.save(model.state_dict(), ckpt_dir / "rgb_baseline_best.pt")
    ...
    best_ckpt = ckpt_dir / "rgb_baseline_best.pt"
    ...
    json_path = results_dir / "rgb_baseline_results.json"
    with open(json_path, "w") as f:
        json.dump(results, f, indent=2)
    print(f"[INFO] Saved JSON results to {json_path}")

    # -------------------- Save confusion matrix heatmap ---
    cm_path = results_dir / "rgb_confusion_matrix.png"
